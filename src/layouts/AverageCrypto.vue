          ...
          <div class="content row justify-between">
            <div class="transaction col-md-4 col-xs-12 q-py-md q-px-sm">
              <div class="card-1 q-pa-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled v-model="harga1" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-2 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled v-model="harga2" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-3 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi3 == false" v-model="harga3" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-4 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi4 == false" v-model="harga4" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-5 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi5 == false" v-model="harga5" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
            </div>
            ...
            <div class="transaction col-md-4 col-xs-12 q-py-md q-px-sm">
              <div class="card-1 q-pa-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi6 == false" v-model="harga6" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-3 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi7 == false" v-model="harga7" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-3 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi8 == false" v-model="harga8" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-4 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi9 == false" v-model="harga9" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
              ...
              <div class="card-5 q-pa-md q-mt-md bg-grey-2" style="border-radius: 4px;">
                ...
                <div class="row q-col-gutter-x-sm q-mt-md">
                  ...
                  <q-input dense square input-class="text-right" filled :disable="transaksi10 == false" v-model="harga10" label="Price Per Coin" class="col-6" prefix="Rp." mask="# ### ### ###"/>
                </div>
              </div>
            </div>
            ...
            <div class="result col-md-4 col-xs-12 q-px-sm q-pt-md">
              ...
              <div class="row q-mt-sm q-gutter-sm">
                <q-btn outline disabled  class="col-grow"  color="primary" label="Add Transaction" icon="add"/>
...
export default {
  ...
  methods: {
    hitung() {
      ...
      const harga6 = this.harga6.replace(/\s+/g,'');
      const harga7 = this.harga7.replace(/\s+/g,'');
      const harga8 = this.harga8.replace(/\s+/g,'');
      const harga9 = this.harga9.replace(/\s+/g,'');
      const harga10 = this.harga10.replace(/\s+/g,'');
